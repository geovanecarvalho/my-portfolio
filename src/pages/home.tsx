  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-700 via-blue-300 to-blue-400">
      ...
      <main className="max-w-5xl mx-auto flex flex-col gap-12 px-2 md:px-6 py-10">
        ...
        <section className="w-full flex flex-col items-center bg-gradient-to-br from-blue-700 via-blue-400 to-blue-450 rounded-3xl shadow-2xl p-8 mb-8 animate-slide-down">
